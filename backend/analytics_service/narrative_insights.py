...
class TANAWNarrativeInsights:
    ...
    def _create_batch_prompt(self, batch: List[Dict], domain: str) -> str:
        ...
        base_prompt = f"""You are a senior business consultant and analytics expert for TANAW, an SME analytics platform. Analyze each chart using the provided detailed data and generate intelligent, actionable business insights with specific recommendations.
